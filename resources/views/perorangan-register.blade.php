...
<section class="section mt-5">
    <div class="container">
        ...
        <h5> Form Registrasi Perorangan</h5>

        <form action="{{ route('perorangan.register.store') }}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <div class="col-lg-6">
                    <div id="hidden_div_lembaga" class="form-group">
                        <label for="no_identitas1">NIK/No.Identitas Pribadi</label>
